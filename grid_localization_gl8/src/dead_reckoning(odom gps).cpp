...
dead_reckoning::dead_reckoning()
{
    ...
    imu_sub_ = nh_.subscribe("/Inertial/imu/data",1,&dead_reckoning::imu_callback,this);   //imu
    ...
    rtkgps_sub_ = nh_.subscribe("/Inertial/gps/fix",1,&dead_reckoning::rtk_callback,this);  //GPS
    ...
    odo_sub = nh_.subscribe("/Inertial/gps/vel",1,&dead_reckoning::odo_callback,this);
...
//        X0(2,0)=-1.67;
    ...
    //    P0(0,0)=1,P0(1,1)=1,P0(2,2)=0.1;
         P0(0,0)=0.1,P0(1,1)=1,P0(2,2)=0.1;
        GPSINS_EKF.init(3,X0,P0);
...
void dead_reckoning::odo_callback(const geometry_msgs::TwistWithCovarianceStamped & msg)
{
