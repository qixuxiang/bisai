...
double OBS_YAW_ERR_ELSE = M_PI; //from gps, unit: rad
double MAPFRAME_SLAM_ERR_FIX = 0.008; //gps error, fix type: 4, unit: m
double MAPFRAME_SLAM_ERR_FLOAT = 1.0; //gps error, fix type: 5, unit: m
double MAPFRAME_SLAM_ERR_SINGLE = 3.0; //gps error, fix type: 1, unit: m
double SLAM_YAW_ERR_FIX = 0.2 * M_PI / 180.0; //from slam, unit: rad
double SLAM_YAW_ERR_ELSE = M_PI;//from slam, unit: rad
