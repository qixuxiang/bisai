...
void mtiCallback(const gl8_msgs::mti1::ConstPtr& msg)
{
    mti1_yaw_rate = msg->yaw_z;  
    curr_yaw_rate = mti1_yaw_rate;
}
...
int main(int argc, char **argv){
    ...
    ros::Subscriber mtisub = nh.subscribe("/mti1_msg", 1000, mtiCallback);
    ...
    nh_priv.param<string>("velocity_output_topic",velocity_output_topic,"/current_velocity");
...
void filter_callback(const ros::TimerEvent&){
    ...
    current_velocity.linear_velocity = curr_vel;
    current_velocity.angular_velocity = curr_yaw_rate;
