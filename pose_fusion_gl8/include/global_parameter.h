...
#define GLOBAL_PARAMETER_H
    ...
    */
    ...
    extern double OBS_YAW_ERR_ELSE; //from gps, unit: rad
    extern double MAPFRAME_SLAM_ERR; //slam error, unit:m
    extern double SLAM_YAW_ERR; //from gps, unit: rad
    extern double MAPFRAME_SLAM_ERR_FIX; //SLAM error, fix type: 4, unit: m
    extern double MAPFRAME_SLAM_ERR_FLOAT; //SLAM error, fix type: 5, unit: m
    extern double MAPFRAME_SLAM_ERR_SINGLE; //SLAM error, fix type: 1, unit: m
    extern double SLAM_YAW_ERR_FIX; //from SLAM, unit: rad
    extern double SLAM_YAW_ERR_ELSE; //from SLAM, unit: rad
