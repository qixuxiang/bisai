...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::NavSatFix> sub_gps_fix(nh, topic_gps, 10);
    message_filters::Subscriber<geometry_msgs::PoseStamped> sub_pose(nh, pose_type, 10);
